...
extension ClosedRange: PrefixContainable {
    ...
    func hasCommonPrefix(with text: String) -> Bool {
        ...
        let trimmedRange: ClosedRange<String> = {
            ...
            let trimmedStart = lower.prefixx(length)
            let trimmedEnd = upper.prefixx(length)
            return trimmedStart...trimmedEnd
        }()

        let trimmedText = text.prefixx(trimmedRange.lowerBound.count)
...
fileprivate extension String {
    ...
    func prefixx(_ maxLength: Int) -> String {
